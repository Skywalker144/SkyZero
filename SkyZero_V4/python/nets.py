...
class ResNet(nn.Module):
    def __init__(self, board_size, num_planes, num_blocks=6, num_channels=128):
        super().__init__()
        self.board_size = board_size
        ...
        self.start_layer = nn.Sequential(
            nn.Conv2d(num_planes, num_channels, kernel_size=3, stride=1, padding=1, bias=False),
...
class ExportWrapper(nn.Module):
    """Wraps ResNet for TorchScript export: dict output -> tuple output."""
