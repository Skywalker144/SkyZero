// Lifted from KataGomo cpp/vcfsolver/VCFsolver.cpp. Algorithm preserved
// verbatim; only namespace + include + table-size adjustments.
//
// MAXNODE = 50000 and table = 2^25 entries (KataGomo "GomoCup" build node
// budget but the standard build's transposition table size — V6 has 64GB
// of RAM so we use the full TT and the larger budget).
...
int32_t VCFsolver::play(int x, int y, uint8_t pla, bool updateHash)
{
  ...
  if (pla == C_MY)
  {
    ...
    int8_t threeCountDir_forRenju[4] = {0, 0, 0, 0};//ÿ���������3����,���ڵ���2˵�������л���
