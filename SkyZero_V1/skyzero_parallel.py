...
import os
import copy
from skyzero import AlphaZero, MCTS, temperature_transform
            ...
            while True:
                ...
                if self.args.get("max_runtime_seconds", -1) > 0:
                    ...
                    if elapsed_total >= self.args["max_runtime_seconds"]:
                        print(f"Reached max runtime ({self.args.get('max_runtime_seconds', -1)}s). Stopping.")
                        break
